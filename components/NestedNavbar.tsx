  ...
  return (
    <div>
      ...
      >
        ...
        <span className="md:block absolute right-3 top-2 md:opacity-0 opacity-100 group-hover:opacity-100 group-hover:translate-x-0 translate-0 md:translate-x-full duration-300 transition-all md:text-white text-black group-hover:text-white">
          Back
        </span>
      </Button>
    </div>
