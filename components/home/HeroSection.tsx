    ...
    <>
      <div className="mb-6 md:mb-10 space-y-2 md:space-y-3 md:px-0">
        ...
        <div className="flex items-start md:items-center gap-4 md:gap-8 font-stack">
          ...
          <Button
            className="rounded-xl md:rounded-2xl cursor-pointer relative flex items-center gap-4 py-4 md:py-6 md:px-6 hover:bg-white shadow-none border border-zinc-200/70"
            variant={"outline"}
            type='button'
          >
            <RippleEffect />
